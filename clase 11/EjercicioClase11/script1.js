...
function sumar(num1, num2) {
  ...
  var res = document.getElementById('resultado').value = num1 + num2;
  return num1 + num2;
}
...
function crearNodoEgreso(){
 var nodo = document.createElement('div');
  nodo.classList.add('egreso-de-sotck');
  var titulo = document.createElement('h2');
  titulo.innerHTML='Egreso de Stock';
...
function crearNodoIngreso(){
  var nodo = document.createElement('div');
   nodo.classList.add('ingreso-de-sotck');
   var titulo = document.createElement('h2');
   titulo.innerHTML='Ingreso de Stock';
   var descripcion = document.createElement('div');
   descripcion.classList.add('descripcion');
   nodo.appendChild(titulo);
   nodo.appendChild(descripcion);
